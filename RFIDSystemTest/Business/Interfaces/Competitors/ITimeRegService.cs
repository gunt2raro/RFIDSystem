...
namespace RFIDSystemTest.Business.Interfaces.Competitors
{
    ...
    public interface ITimeRegService
    {
        ...
        List<TimeReg> getByRegister(Register register, UserSystem user_log);
        List<TimeReg> getByDate(DateTime date, UserSystem user_log);
        List<TimeReg> getByCompetition(Competition competition, UserSystem user_log);
